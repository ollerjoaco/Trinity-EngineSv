...
#define FL_ELIGHT					BIT(14)
#define FL_DLIGHT					BIT(15)
#define FL_SPOTLIGHT				BIT(16)
#define FL_WATERSHADER				BIT(17)
#define FL_MIRROR					BIT(18)
#define FL_NOSHADOW					BIT(19)
#define FL_NOMODEL					BIT(20)
