...
// Trinity
class CCSFuncMirror: public CCSFuncWall {};
class CCSItemGeneric: public CCSEntity {};
class CCSDynamicLight: public CCSLight {};
class CCSEnvPos_Sky: public CCSPointEntity {};
class CCSEnvPos_World: public CCSPointEntity {};
class CCSEnvDecal: public CCSEntity {};
class CCSEnvParticle: public CCSEntity {};
